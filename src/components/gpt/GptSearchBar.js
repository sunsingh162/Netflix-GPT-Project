		...
		<>
			...
			<div className=" flex justify-center sticky  top-[70px] md:top-20 z-30 px-2 sm:p-0">
				...
				>
					<input
						ref={searchText}
						className="col-span-9 px-6 py-2 text-center text-black outline-none rounded-s-full"
						type="text"
						placeholder={lang[langCode].placeholder}
					/>
					<button
						className="col-span-3 bg-red-700 rounded-r-full outline-none hover:border-red-800 active:bg-red-900"
